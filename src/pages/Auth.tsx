  ...
  return <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          {step === 'otp' && <Button variant="ghost" size="sm" onClick={goBack} className="absolute left-4 top-4">
              <ArrowLeft className="h-4 w-4" />
            </Button>}
          <CardTitle className="text-2xl font-bold">Errand Dash</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          {step === 'phone' && <form onSubmit={handleSendOtp} className="space-y-6">
              <PhoneInput value={phone} onChange={setPhone} disabled={isLoading} />
              <Button type="submit" className="w-full" disabled={isLoading || !validateNigerianNumber(phone)}>
                {isLoading ? <>
          ...
          {step === 'otp' && <form onSubmit={handleVerifyOtp} className="space-y-6">
              ...
              <div className="text-center">
                <Button type="button" variant="ghost" onClick={handleResendCode} disabled={countdown > 0 || isLoading} className="text-sm">
                  {countdown > 0 ? <>
          ...
          {step === 'success' && <div className="text-center space-y-4">
